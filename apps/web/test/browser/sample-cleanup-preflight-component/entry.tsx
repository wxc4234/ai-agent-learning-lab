...
import TaskSampleCleanupPreflightPanel from "../../../src/features/workbench/components/task-sample-cleanup-preflight-panel";
...
function Fixture() {
    ...
    return (
        <div className="grid h-dvh grid-cols-[320px_minmax(0,1fr)_400px]">
            ...
            <main className="p-5">清理待办只读诊断组件隔离验收</main>
