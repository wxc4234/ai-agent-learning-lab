...
def test_run_repository_records_and_loads_timeline(monkeypatch, engine, owner_id):
    ...
    timeline = run_repository.load_run_timeline(run_id, user_id=owner_id)
...
def test_cancelling_a_running_run_records_its_terminal_event(monkeypatch, engine, owner_id):
    ...
    assert run_repository.request_run_cancellation(run_id, "user", user_id=owner_id) is True
    assert run_repository.request_run_cancellation(run_id, "timeout", user_id=owner_id) is False
