"""Logout transactions on isolated PostgreSQL; run: python -m pytest -q tests/auth/test_logout_service.py."""
...
from app.services.auth import logout_service as service
from app.services.auth.login_session_resolver import InvalidLoginSessionError, resolve_login_session
