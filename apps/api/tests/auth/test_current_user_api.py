...
Run from apps/api: python -m pytest -q tests/auth/test_current_user_api.py
...
from app.repositories.auth.login_session_repository import revoke_login_session
