...
Run from apps/api: python -m pytest -q tests/auth/test_login_session_resolver.py
"""
...
from app.repositories.auth.login_session_repository import create_login_session, revoke_login_session
from app.repositories.auth.user_repository import get_user_by_id
from app.schemas import LoginRequest, RegisterRequest
from app.services.auth import login_session_resolver as resolver
